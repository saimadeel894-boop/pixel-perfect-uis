  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(255, 129, 75, 0.3)" },
          "50%": { boxShadow: "0 0 40px rgba(255, 129, 75, 0.5)" },
        },
      },
      animation: {
        ...
        "fab-expand": "fab-expand 0.3s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
        "fab-collapse": "fab-collapse 0.2s ease-out forwards",
